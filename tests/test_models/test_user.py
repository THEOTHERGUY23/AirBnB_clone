...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[User] (543210)", user1_str)
        self.assertIn("'id': '543210'", user1_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        user1 = User(id="321", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(user1.id, "321")
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "Mnguni"
        us.my_number = 23
        self.assertEqual("Mnguni", us.middle_name)
