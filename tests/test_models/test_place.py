...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Place] (543210)", my_place_str)
        self.assertIn("'id': '543210'", my_place_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        my_place = Place(id="321", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(my_place.id, "321")
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_place = Place()
        my_place.middle_name = "Mnguni"
        my_place.my_number = 321
        self.assertEqual("Mnguni", my_place.middle_name)
