...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[State] (543210)", state_str)
        self.assertIn("'id': '543210'", state_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        state = State(id="321", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(state.id, "321")
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        state = State()
        state.middle_name = "Mnguni"
        state.my_number = 321
        self.assertEqual("Mnguni", state.middle_name)
