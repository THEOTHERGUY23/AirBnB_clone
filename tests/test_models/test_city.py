...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[City] (543210)", my_city_str)
        self.assertIn("'id': '543210'", my_city_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        my_city = City(id="1475", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(my_city.id, "1475")
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_city = City()
        my_city.middle_name = "Mnguni"
        my_city.my_number = 321
        self.assertEqual("Mnguni", my_city.middle_name)
