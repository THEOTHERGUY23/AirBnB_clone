...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Amenity] (543210)", amenity_str)
        self.assertIn("'id': '543210'", amenity_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        amenity1 = Amenity(id="123", created_at=my_date_iso, updated_at=my_date_iso)
